...
abstract class $SignInScreenStateCopyWith<$Res> {
  ...
  $Res call({String userName, int userId, String uid, bool isObscure});
}
...
class _$_SignInScreenState implements _SignInScreenState {
  ...
  @override
  String toString() {
    return 'SignInScreenState(userName: $userName, userId: $userId, uid: $uid, isObscure: $isObscure)';
  }
...
abstract class _SignInScreenState implements SignInScreenState {
  const factory _SignInScreenState(
      ...
      int userId,
      String uid,
      bool isObscure}) = _$_SignInScreenState;
